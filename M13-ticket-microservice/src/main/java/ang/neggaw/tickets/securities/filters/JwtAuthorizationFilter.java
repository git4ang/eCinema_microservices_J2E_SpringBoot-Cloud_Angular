package ang.neggaw.tickets.securities.filters;

import ang.neggaw.tickets.securities.models.MyHttpResponse;
import ang.neggaw.tickets.securities.services.JwtServiceImpl;
...
public class JwtAuthorizationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if(request.getServletPath().startsWith("/actuator") || request.getServletPath().startsWith("/open-api")) {
